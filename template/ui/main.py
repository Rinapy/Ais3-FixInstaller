...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icons/fix.ico"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"background-color: rgb(83, 83, 83);")
        ...
        self.widget.setGeometry(QtCore.QRect(10, 10, 251, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Текущая версия Ais3Prom:"))
